...
function startGame() {
    //ascunde butonul daca e nevoie
    startButton.classList.add("hidden")
    //intervalul este de 1sec (1000ms)
    let interval = 1000
...
//genereaza o pozitie aleatorie intre 0%-90%
...
function createNewLetter() {
    ...
    //cream un nou element de tip div (initial este gol si nu are stil)
